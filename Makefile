...
SRC += src/g_main.c src/r_renderfuncs.c src/z_coreloop.c src/z_player.c src/z_zombies.c src/s_tilemap.c src/s_scene.c src/s_entities.c src/s_animation.c src/s_weapons.c src/z_upgradecrate.c
